...
BITS_DATOS = 8                 # 1 byte ASCII por carácter
BITS_TRAMA = BITS_DATOS + 1    # + 1 bit de paridad (Capa de Enlace de Datos)
FRECUENCIA_PORTADORA = 5       # Hz simulados (onda seno - ASK)
MUESTRAS_POR_BIT = 120         # Resolución de muestreo POR BIT (fijo y exacto, sin residuos)
MUESTRAS_POR_CARACTER = MUESTRAS_POR_BIT * BITS_TRAMA  # Total de muestras por carácter (1080)
NIVELES_ASK = 2                # ASK binario: amplitud 0 (apagado) o 1 (encendido)
UMBRAL_DETECCION = 0.35        # Umbral RMS para decidir si el receptor lee 1 o 0
...
class SimuladorContextoRealUNEMI:
    def __init__(self, root):
        ...
        osi_frame.grid(row=2, column=0, sticky="ew", padx=20)
